...
<? if( !empty(array_intersect(array(33), CUser::GetUserGroup($USER->GetID()))) ) { ?>
 <div class="w3-button w3-mobile w3-third w3-center">
	 <a href="/mobile/sites/sts/hfgd/salg/index.php">
...
<? if( !empty(array_intersect(array(33), CUser::GetUserGroup($USER->GetID()))) ) { ?>
 <div class="w3-button w3-mobile w3-third w3-center">
  <a href="/mobile/sites/sts/hfgd/mek/index.php">
...
<? if( !empty(array_intersect(array(33), CUser::GetUserGroup($USER->GetID()))) ) { ?>
 <div class="w3-button w3-mobile w3-third w3-center">
  <a href="/mobile/sites/sts/hfgd/plade/index.php">
  <i class="material-icons md-72 icon-blue">local_car_wash</i>
  <p>PLADE</p>
  </a>
</div>
