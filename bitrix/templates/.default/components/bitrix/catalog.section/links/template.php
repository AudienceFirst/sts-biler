...
// fix links SB-58
		...
		{
			$res = CIBlockElement::GetProperty($arElement['IBLOCK_ID'], $arElement['ID'], array("sort" => "asc"), array("CODE" => "URL"));
			if($ar_props = $res->Fetch())
			{
				$arElement["DETAIL_PAGE_URL"] = $ar_props['VALUE'];
			}
		}
		?>
