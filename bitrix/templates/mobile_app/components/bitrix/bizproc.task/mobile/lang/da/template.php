...
$MESS["MB_BP_SKIP"] = "This Opgaver cannot be accomplished in the mobile application. Please open the portal in your browser and view the Opgaver there (use the \"Workflow\" menu item).";
...
$MESS["MB_BP_DETAIL_REQUEST_ERROR"] = "Error sending request while performing Opgaver.";
?>