...
$isDDB = (in_array(12, $getGroups)) ? true : false;
$isBoC = (in_array(23, $getGroups)) ? true : false;
$isSDK = (in_array(29, $getGroups)) ? true : false;
$isMFA = (in_array(21, $getGroups)) ? true : false;
$isSTS = (in_array(17, $getGroups)) ? true : false;
...
JS
        ...
        [
            ...
            "color" => "#3CD162",
            "title" => Loc::getMessage("MB_SHARED_FILES_MAIN_MENU_ITEM_NEW")." DDB",
            "attrs" => [
                "onclick" => <<<JS
...
JS
            ...
            "hidden" => !$diskEnabled || $isExtranetUser || !$allowedFeatures["files"] || !$isDDB,
        ...
        [
            "imageUrl" => $imageDir . "favorite/icon-disk.png",
            "color" => "#3CD162",
            "title" => Loc::getMessage("MB_SHARED_FILES_MAIN_MENU_ITEM_NEW")." Bil og Co",
            "attrs" => [
                "onclick" => <<<JS
                    ...
                    if(Application.getApiVersion() >= 28)
                        {
                            ComponentHelper.openList({
                                    ...
                                    object:"list",
                                    version:"{$diskComponentVersion}",
                                    componentParams:{userId: env.userId, ownerId: "shared_files_rc", entityType:"common"},
                                    widgetParams:{title:"{$hereDocGetMessage("MB_SHARED_FILES_MAIN_MENU_ITEM_NEW")}"}
                            });
                        }
                        else 
                        {
                            PageManager.openList(
                            {
                                url:"/mobile/?mobile_action=disk_folder_list&type=common&path=/&entityId=shared_files_rc",
                                table_settings: 
                                {
                                    name:"{$hereDocGetMessage("MB_SHARED_FILES_MAIN_MENU_ITEM_NEW")}",
                                    showTitle:"YES",
...
JS
            ...
            "hidden" => !$diskEnabled || $isExtranetUser || !$allowedFeatures["files"] || !$isBoC,
        ...
        [
            "imageUrl" => $imageDir . "favorite/icon-disk.png",
            "color" => "#3CD162",
            "title" => Loc::getMessage("MB_SHARED_FILES_MAIN_MENU_ITEM_NEW")." SDK",
            "attrs" => [
                "onclick" => <<<JS
                    ...
                    if(Application.getApiVersion() >= 28)
                        {
                            ComponentHelper.openList({
                                    ...
                                    object:"list",
                                    version:"{$diskComponentVersion}",
                                    componentParams:{userId: env.userId, ownerId: "shared_files_qy", entityType:"common"},
                                    widgetParams:{title:"{$hereDocGetMessage("MB_SHARED_FILES_MAIN_MENU_ITEM_NEW")}"}
                            });
                        }
                        else 
                        {
                            PageManager.openList(
                            {
                                url:"/mobile/?mobile_action=disk_folder_list&type=common&path=/&entityId=shared_files_qy",
                                table_settings: 
                                {
                                    name:"{$hereDocGetMessage("MB_SHARED_FILES_MAIN_MENU_ITEM_NEW")}",
                                    showTitle:"YES",
...
JS
            ...
            "hidden" => !$diskEnabled || $isExtranetUser || !$allowedFeatures["files"] || !$isSDK,
        ...
        [
            "imageUrl" => $imageDir . "favorite/icon-disk.png",
            "color" => "#3CD162",
            "title" => Loc::getMessage("MB_SHARED_FILES_MAIN_MENU_ITEM_NEW")." MFA",
            "attrs" => [
                "onclick" => <<<JS
                    ...
                    if(Application.getApiVersion() >= 28)
                        {
                            ComponentHelper.openList({
                                    ...
                                    object:"list",
                                    version:"{$diskComponentVersion}",
                                    componentParams:{userId: env.userId, ownerId: "shared_files_py", entityType:"common"},
                                    widgetParams:{title:"{$hereDocGetMessage("MB_SHARED_FILES_MAIN_MENU_ITEM_NEW")}"}
                            });
                        }
                        else 
                        {
                            PageManager.openList(
                            {
                                url:"/mobile/?mobile_action=disk_folder_list&type=common&path=/&entityId=shared_files_py",
                                table_settings: 
                                {
                                    name:"{$hereDocGetMessage("MB_SHARED_FILES_MAIN_MENU_ITEM_NEW")}",
                                    showTitle:"YES",
...
JS
            ...
            "hidden" => !$diskEnabled || $isExtranetUser || !$allowedFeatures["files"] || !$isMFA,
        ...
        [
            "imageUrl" => $imageDir . "favorite/icon-disk.png",
            "color" => "#3CD162",
            "title" => Loc::getMessage("MB_SHARED_FILES_MAIN_MENU_ITEM_NEW")." STS",
            "attrs" => [
                "onclick" => <<<JS
                    ...
                    if(Application.getApiVersion() >= 28)
                        {
                            ComponentHelper.openList({
                                    ...
                                    object:"list",
                                    version:"{$diskComponentVersion}",
                                    componentParams:{userId: env.userId, ownerId: "shared_files_mh", entityType:"common"},
                                    widgetParams:{title:"{$hereDocGetMessage("MB_SHARED_FILES_MAIN_MENU_ITEM_NEW")}"}
                            });
                        }
                        else 
                        {
                            PageManager.openList(
                            {
                                url:"/mobile/?mobile_action=disk_folder_list&type=common&path=/&entityId=shared_files_mh",
                                table_settings: 
                                {
                                    name:"{$hereDocGetMessage("MB_SHARED_FILES_MAIN_MENU_ITEM_NEW")}",
                                    showTitle:"YES",
...
JS
            ...
            "hidden" => !$diskEnabled || $isExtranetUser || !$allowedFeatures["files"] || !$isSTS,
        ...
        [
            "imageUrl" => $imageDir . "favorite/icon-disk.png",
            "color" => "#3CD162",
            "title" => Loc::getMessage("MB_SHARED_FILES_MAIN_MENU_ITEM_NEW")." ERA",
            "attrs" => [
                "onclick" => <<<JS
                    ...
                    if(Application.getApiVersion() >= 28)
                        {
                            ComponentHelper.openList({
                                    ...
                                    object:"list",
                                    version:"{$diskComponentVersion}",
                                    componentParams:{userId: env.userId, ownerId: "shared_files_lb", entityType:"common"},
                                    widgetParams:{title:"{$hereDocGetMessage("MB_SHARED_FILES_MAIN_MENU_ITEM_NEW")}"}
                            });
                        }
                        else 
                        {
                            PageManager.openList(
                            {
                                url:"/mobile/?mobile_action=disk_folder_list&type=common&path=/&entityId=shared_files_lb",
                                table_settings: 
                                {
                                    name:"{$hereDocGetMessage("MB_SHARED_FILES_MAIN_MENU_ITEM_NEW")}",
                                    showTitle:"YES",
...
JS
            ...
            "hidden" => !$diskEnabled || $isExtranetUser || !$allowedFeatures["files"] || !$isERA,
        ...
        [
            "imageUrl" => $imageDir . "favorite/icon-disk.png",
            "color" => "#3CD162",
            "title" => Loc::getMessage("MB_SHARED_FILES_MAIN_MENU_ITEM_NEW")." Auto",
            "attrs" => [
                "onclick" => <<<JS
                    ...
                    if(Application.getApiVersion() >= 28)
                        {
                            ComponentHelper.openList({
                                    ...
                                    object:"list",
                                    version:"{$diskComponentVersion}",
                                    componentParams:{userId: env.userId, ownerId: "shared_files_ku", entityType:"common"},
                                    widgetParams:{title:"{$hereDocGetMessage("MB_SHARED_FILES_MAIN_MENU_ITEM_NEW")}"}
                            });
                        }
                        else 
                        {
                            PageManager.openList(
                            {
                                url:"/mobile/?mobile_action=disk_folder_list&type=common&path=/&entityId=shared_files_ku",
                                table_settings: 
                                {
                                    name:"{$hereDocGetMessage("MB_SHARED_FILES_MAIN_MENU_ITEM_NEW")}",
                                    showTitle:"YES",
...
JS
            ...
            "hidden" => !$diskEnabled || $isExtranetUser || !$allowedFeatures["files"] || !$isAuto,
        ...
        [
            "imageUrl" => $imageDir . "favorite/icon-disk.png",
            "color" => "#3CD162",
            "title" => Loc::getMessage("MB_SHARED_FILES_MAIN_MENU_ITEM_NEW")." NHE",
            "attrs" => [
                "onclick" => <<<JS
                    ...
                    if(Application.getApiVersion() >= 28)
                        {
                            ComponentHelper.openList({
                                    ...
                                    object:"list",
                                    version:"{$diskComponentVersion}",
                                    componentParams:{userId: env.userId, ownerId: "shared_files_jf", entityType:"common"},
                                    widgetParams:{title:"{$hereDocGetMessage("MB_SHARED_FILES_MAIN_MENU_ITEM_NEW")}"}
                            });
                        }
                        else 
                        {
                            PageManager.openList(
                            {
                                url:"/mobile/?mobile_action=disk_folder_list&type=common&path=/&entityId=shared_files_jf",
                                table_settings: 
                                {
                                    name:"{$hereDocGetMessage("MB_SHARED_FILES_MAIN_MENU_ITEM_NEW")}",
                                    showTitle:"YES",
...
JS
            ...
            "hidden" => !$diskEnabled || $isExtranetUser || !$allowedFeatures["files"] || !$isNHE,
