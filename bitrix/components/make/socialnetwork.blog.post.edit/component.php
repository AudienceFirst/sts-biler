...
$POST_SITE_ID = $arParams['SONET_SITE_ID'];
            ...
            if (check_bitrix_sessid())
            {
                if(strlen($arResult["ERROR_MESSAGE"]) <= 0)
                {
                    ...
                    if (!empty($_POST["SPERM"]))
                    {
                        ...
                        // $arFields["SOCNET_RIGHTS"] = [$arParams['SOCNET_RIGHTS']];
                    ...
                    if(!$bError)
                    {
                        ...
                        )
                        {
                            ...
                            dump_log(__LINE__);
                            dump_log($arFields);
                            // dump_log(print_r(var_dump($logEntryActivated),1));
                    ...
                    dump_log(__LINE__);
                    dump_log($newID);
                    dump_log(print_r(var_dump($arResult["ERROR_MESSAGE"]), 1));
                    ...
                    ) // Record saved successfully
                    {
                        ...
                        // dump_log($arPostFields);
                        // dump_log(EVENT_ID_POST);
                        // dump_log($eventId);
                        ...
                        )
                        {
                            ...
                            dump_log(EVENT_ID_POST_IMPORTANT);
                        ...
                        // dump_log($eventId);
                        // dump_log($logId);
                        // dump_log($arFields["PUBLISH_STATUS"]);
                        // dump_log(BLOG_PUBLISH_STATUS_PUBLISH);
                        ...
                        // var_dump($arFields["PUBLISH_STATUS"]);
                        // var_dump(BLOG_PUBLISH_STATUS_PUBLISH);
                        ...
                        dump_log($arResult['ERROR_MESSAGE']);
                        dump_log($redirectUrl);
